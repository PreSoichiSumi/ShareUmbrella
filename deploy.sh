...
sudo -E scp -o StristHostkeyChecking=no -o UserKnownHostFile=/dev/null -Bv -i data.pem shareUmbrella.war ec2-user@ec2-54-238-225-208.ap-northeast-1.compute.amazonaws.com:/home/ec2-user
